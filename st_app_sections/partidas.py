...
def partidas():
    ...
    if option == 'Grupo 1':
        ...
        with col1:
            if st.session_state.df[f"Jogo1"].sum(axis=0)!=41:
        ...
        with col2:
            ...
            if st.session_state.df[f"Jogo2"].sum(axis=0)!=41:   
        ...
        with col1:
            if st.session_state.df[f"Jogo3"].sum(axis=0)!=41:
        ...
        with col2:
            if st.session_state.df[f"Jogo4"].sum(axis=0)!=41:
        ...
        with col2:
            if st.session_state.df2[f"Jogo2"].sum(axis=0)!=41:   
        ...
        with col1:
            if st.session_state.df2[f"Jogo3"].sum(axis=0)!=41:
        ...
        with col2:
            if st.session_state.df2[f"Jogo4"].sum(axis=0)!=41:
        ...
        col1,col2 = st.columns(2)      
        with col1:
            if st.session_state.df3[f"Jogo1"].sum(axis=0)!=41:
        ...
        with col2:
            if st.session_state.df3[f"Jogo2"].sum(axis=0)!=41:   
        ...
        with col1:
            if st.session_state.df3[f"Jogo3"].sum(axis=0)!=41:
        ...
        with col2:
            if st.session_state.df3[f"Jogo4"].sum(axis=0)!=41:
        ...
        col1,col2 = st.columns(2) 
        with col1:
            if st.session_state.df4[f"Jogo1"].sum(axis=0)!=41:
        ...
        with col2:
            if st.session_state.df4[f"Jogo2"].sum(axis=0)!=41:   
        ...
        with col1:
            if st.session_state.df4[f"Jogo3"].sum(axis=0)!=41:
        ...
        with col2:
            if st.session_state.df4[f"Jogo4"].sum(axis=0)!=41:
        ...
        col1,col2 = st.columns(2) 
        with col1:
            if st.session_state.df5[f"Jogo1"].sum(axis=0)!=41:
                jogo_15 = st.button('Jogo-1')
                j=1
                ...
                if jogo_15:
                    ...
                    st.session_state.df5["Pontos"]= st.session_state.df5["Pontos"]+st.session_state.df5[f"Jogo{j}"]
        ...
        with col2:
            if st.session_state.df5[f"Jogo2"].sum(axis=0)!=41:   
                jogo_25 = st.button('Jogo-2')
                j=2
                if jogo_25:
                    pos=func(st.session_state.df5,j)
        ...
        with col1:
            if st.session_state.df5[f"Jogo3"].sum(axis=0)!=41:
                jogo_35 = st.button('Jogo-3')
                j=3
                if jogo_35:
                    pos=func(st.session_state.df5,j)
                    tabela_view=tabela_view.merge(pos, on="Nick",how='left')
                    ...
                    st.session_state.df5.reset_index(drop=True,inplace=True)
                    st.session_state.df5.index+=1
                    st.session_state.df5[["Nick","Jogo1","Jogo2","Jogo3","Pontos"]]
                    st.session_state.df5
                    st.experimental_rerun()

        with col2:
            if st.session_state.df5[f"Jogo4"].sum(axis=0)!=41:
                jogo_45 = st.button('Jogo-4')
                j=4
                if jogo_45:
                    pos=func(st.session_state.df5,j)
                    tabela_view=tabela_view.merge(pos, on="Nick",how='left')
                    ...
                    st.session_state.df5.reset_index(drop=True,inplace=True)
                    st.session_state.df5.index+=1
                    st.session_state.df5[["Nick","Jogo1","Jogo2","Jogo3","Jogo4","Pontos"]]
                    st.session_state.df5
                    st.experimental_rerun()
        ...
        with col1:
            if st.session_state.df5[f"Jogo1"].sum(axis=0)!=41:
                ...
                if jogo_16:
                    ...
                    st.session_state.df6["Pontos"]= st.session_state.df6["Pontos"]+st.session_state.df6[f"Jogo{j}"]
        ...
        with col2:
            if st.session_state.df6[f"Jogo2"].sum(axis=0)!=41:   
                jogo_26 = st.button('Jogo-2')
                j=2
                if jogo_26:
                    pos=func(st.session_state.df6,j)
                    ...
                    st.session_state.df6.reset_index(drop=True,inplace=True)
                    st.session_state.df6.index+=1
                    st.session_state.df6=st.session_state.df6[["Nick","Jogo1","Jogo2","Pontos"]]
                    st.session_state.df6
                    st.experimental_rerun()

        with col1:
            if st.session_state.df6[f"Jogo3"].sum(axis=0)!=41:
                jogo_36 = st.button('Jogo-3')
                j=3
                if jogo_36:
                    pos=func(st.session_state.df6,j)
                    tabela_view=tabela_view.merge(pos, on="Nick",how='left')
                    ...
                    st.session_state.df6.reset_index(drop=True,inplace=True)
                    st.session_state.df6.index+=1
                    st.session_state.df6[["Nick","Jogo1","Jogo2","Jogo3","Pontos"]]
                    st.session_state.df6
                    st.experimental_rerun()

        with col2:
            if st.session_state.df6[f"Jogo4"].sum(axis=0)!=41:
                jogo_46 = st.button('Jogo-4')
                j=4
                if jogo_46:
                    pos=func(st.session_state.df6,j)
                    tabela_view=tabela_view.merge(pos, on="Nick",how='left')
                    ...
                    st.session_state.df6.reset_index(drop=True,inplace=True)
                    st.session_state.df6.index+=1
                    st.session_state.df6[["Nick","Jogo1","Jogo2","Jogo3","Jogo4","Pontos"]]
                    st.session_state.df6
                    st.experimental_rerun()
        ...
        col1,col2 = st.columns(2) 
        with col1:
            if st.session_state.df7[f"Jogo1"].sum(axis=0)!=41:
                jogo_17 = st.button('Jogo-1')
                j=1
                ...
                if jogo_17:
                    ...
                    st.session_state.df7["Pontos"]= st.session_state.df7["Pontos"]+st.session_state.df7[f"Jogo{j}"]
        ...
        with col2:
            if st.session_state.df7[f"Jogo2"].sum(axis=0)!=41:   
                jogo_27 = st.button('Jogo-2')
                j=2
                if jogo_27:
                    pos=func(st.session_state.df7,j)
        ...
        with col1:
            if st.session_state.df7[f"Jogo3"].sum(axis=0)!=41:
                jogo_37 = st.button('Jogo-3')
                j=3
                if jogo_37:
                    pos=func(st.session_state.df7,j)
                    tabela_view=tabela_view.merge(pos, on="Nick",how='left')
                    ...
                    st.session_state.df7.reset_index(drop=True,inplace=True)
                    st.session_state.df7.index+=1
                    st.session_state.df7[["Nick","Jogo1","Jogo2","Jogo3","Pontos"]]
                    st.session_state.df7
                    st.experimental_rerun()

        with col2:
            if st.session_state.df7[f"Jogo4"].sum(axis=0)!=41:
                jogo_47 = st.button('Jogo-4')
                j=4
                if jogo_47:
                    pos=func(st.session_state.df7,j)
                    tabela_view=tabela_view.merge(pos, on="Nick",how='left')
                    ...
                    st.session_state.df7.reset_index(drop=True,inplace=True)
                    st.session_state.df7.index+=1
                    st.session_state.df7[["Nick","Jogo1","Jogo2","Jogo3","Jogo4","Pontos"]]
                    st.session_state.df7
                    st.experimental_rerun()
